  ...
  return (
    <div className=" mt-15 bg-[#f9fafc] p-20">
      ...
      <div className="grid grid-cols-3 gap-3 w-11/12 mx-auto">
        <div className="left-card rounded-xl shadow-sm  flex flex-col justify-center items-center p-5 bg-white">
          ...
          <h1 className="font-bold text-2xl my-2">Create Account</h1>
